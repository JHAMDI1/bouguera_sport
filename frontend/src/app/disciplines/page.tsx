      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {disciplines?.map((discipline) => (
            <div key={discipline._id} className="bg-white rounded-lg shadow p-6">
              ...
              <div className="flex items-center justify-between">
                <div className="text-lg font-bold text-purple-600">
                  {discipline.monthlyFee} TND<span className="text-sm font-normal text-gray-500">/mois</span>
                </div>
        ...
        {disciplines?.length === 0 && (
          <div className="text-center py-8 text-gray-500">Aucune discipline trouvée</div>
        )}
      </main>
    </div>
  );
